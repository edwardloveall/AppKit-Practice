...
class Document: NSDocument, NSWindowDelegate {
  ...
  let SiblingPadding: CGFloat = 8
  let ParentPadding: CGFloat = 20
  ...
  func addAutoLayoutConstraints() {
    ...
    addEmployee.topAnchor.constraintEqualToAnchor(view.topAnchor,
                                                  constant: ParentPadding).active = true
    addEmployee.leadingAnchor.constraintEqualToAnchor(scrollView.trailingAnchor,
                                                      constant: SiblingPadding).active = true
    removeEmployee.topAnchor.constraintEqualToAnchor(addEmployee.bottomAnchor,
                                                     constant: SiblingPadding).active = true
    removeEmployee.leadingAnchor.constraintEqualToAnchor(scrollView.trailingAnchor,
                                                         constant: SiblingPadding).active = true
    removeEmployee.widthAnchor.constraintEqualToAnchor(addEmployee.widthAnchor).active = true
    ...
    scrollView.leadingAnchor.constraintEqualToAnchor(view.leadingAnchor,
                                                     constant: ParentPadding).active = true
    scrollView.widthAnchor.constraintGreaterThanOrEqualToConstant(200).active = true
    scrollView.heightAnchor.constraintGreaterThanOrEqualToConstant(100).active = true
    view.trailingAnchor.constraintEqualToAnchor(addEmployee.trailingAnchor,
                                                constant: ParentPadding).active = true
    view.bottomAnchor.constraintEqualToAnchor(scrollView.bottomAnchor,
                                              constant: ParentPadding).active = true
    view.bottomAnchor.constraintGreaterThanOrEqualToAnchor(removeEmployee.bottomAnchor,
                                                           constant: ParentPadding).active = true
  }
